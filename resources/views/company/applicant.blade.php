                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-4 col-sm-12 col-xl-4">
                            ...
                            <select name="sub_cat" class="form-control">
                                    <option value="0" selected>...Choose Sub Category...</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action text-center">
                                        @if ($d->status==0)
                                        <button id="success" class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#h{{ $d->id }}"><i class="fa fa-check text"></i>Invite</button>
                                        @else
                                        <button disabled class="btn btn-outline-secondary btn-sm"> <i class="fa fa-call">invited</i></button>
                                        @endif                                    
                                        <button class="btn btn-outline-success btn-sm"> <i class="fa fa-phone" aria-hidden="true"></i></button>
                                        <a href="{{route('company.message',$d->user)}}"><button class="btn btn-outline-info btn-sm"> <i class="fa fa-envelope"></i></button></a>
                                </div>
